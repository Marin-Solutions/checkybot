...
{
    private const PROJECT_INSPECTION_OPTIONS = [
    ...
    protected static ?string $title = 'Application Notifications';
        ...
        return $schema
            ->schema([
                Forms\Components\Select::make('inspection')
                    ->label('Monitor')
                    ->options(self::PROJECT_INSPECTION_OPTIONS)
                    ->default(WebsiteServicesEnum::ALL_CHECK->value)
                    ->required(),
                ...
                Forms\Components\Select::make('notification_channel_id')
                    ...
                    ->rules([
                        fn (Get $get): \Closure => function (string $attribute, $value, \Closure $fail) use ($get): void {
                            ...
                            if (! $owned) {
                                $fail('Select one of this application owner\'s webhook channels.');
                            }
                        },
                    ])
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('No application alerts configured')
            ->emptyStateDescription('Add an alert below to route incidents from this application to the right team channel.')
    ...
    protected function mutateNotificationData(array $data): array
    {
        ...
        $data['project_component_id'] = null;
        $data['scope'] = NotificationScopesEnum::PROJECT->value;
