...
test('swagger documentation can be generated', function () {
    ...
    expect(storage_path('api-docs/api-docs.json'))->toBeFile()
        ...
        ->and($requestSchema('/v1/package/sync')['properties']['checks']['items']['oneOf'][0]['properties']['save_failed_response']['type'])->toBe('boolean')
        ...
        ->and($requestSchema('/v1/package/sync')['properties']['checks']['items']['oneOf'][1]['required'])->toBe(['key', 'type', 'name', 'url', 'schedule'])
        ...
        ->and($requestSchema('/v1/projects/{project}/checks/sync')['properties']['uptime_checks']['maxItems'])->toBe(100)
        ...
        ->and($requestSchema('/v1/projects/{project}/checks/sync')['properties']['ssl_checks']['maxItems'])->toBe(100)
